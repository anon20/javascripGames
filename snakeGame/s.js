...
function eaten_own_body(){
	...
	{//console.log("EXECUTING");
		if(r.body[i].pos_x==r.body[0].pos_x && r.body[i].pos_y==r.body[0].pos_y)
		{	//console.log("s_o.body[0].pos_x = "+s_o.body[0].pos_x+" s_o.body[0].pos_y = "+s_o.body[0].pos_y);
...
var game_area = {
	...
	stop: function(){high_scores.push(score);
...
window.onkeydown = function(e){
	...
	if(e.keyCode==39&&r.body[0].angle!=180)
	{	//console.log("RIGHT");
		turn_snake("r");
	} 
	if(e.keyCode==37&&r.body[0].angle!=0)
	{	//console.log("LEFT");
		turn_snake("l");
	}
	if(e.keyCode==38&&r.body[0].angle!=90)
	{	//console.log("UP");
		turn_snake("u");
	} 
	if(e.keyCode==40&&r.body[0].angle!=-90)
	{	//console.log("DOWN");
		turn_snake("d");
	} 
}
